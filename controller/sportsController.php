<?php
    include 'model/sportsModel.php';
    include 'model/sports.php';
    include 'config.php';
	...
	class sportsController 
	{
        ...
        {    $noerror=true;
            ...
            if(empty($sporttb->pname)){
                $sporttb->pname_msg = "Field is empty.";$noerror=false;
            } elseif(!filter_var($sporttb->pname, FILTER_VALIDATE_REGEXP, array("options"=>array("regexp"=>"/^[a-zA-Z\s]+$/")))){
                $sporttb->pname_msg = "Invalid entry.";$noerror=false;
            }else{$sporttb->pname_msg ="";} 
		...
		public function insert()
		{
            ...
            {   
                // read form value
                $sporttb->pname = trim($_POST['pname']);
